    ...
    <div class="row">
      <div class="col-md-12">  
        <div class="col-md-10 col-md-offset-1">
          <img src="{{ asset('/uploads/documents/') }}/{{$document->ine}}" style="width: 50%; height: 300px; float: left;  margin-right: 25px; " alt="">
          <h2>INE</h2>
          <form action="{{ url('/ine') }}" enctype="multipart/form-data" method="POST">
            {{ csrf_field() }}
